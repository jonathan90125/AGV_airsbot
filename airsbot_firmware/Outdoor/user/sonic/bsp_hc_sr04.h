...
#define UL_GPIO_CLK    RCC_APB2Periph_GPIOD
#define UL_GPIO_CLK_FUNCTION  RCC_APB2PeriphClockCmd
#define UL_GPIO_PORT_SOURCE  GPIO_PortSourceGPIOD
...
#define UL1_ECHO_PIN   GPIO_Pin_11
#define UL1_EXTI_LINE  EXTI_Line11
#define UL1_GPIO_PIN_SOURCE  GPIO_PinSource11

#define UL2_TRIG_PIN   GPIO_Pin_6
#define UL2_ECHO_PIN   GPIO_Pin_7
#define UL2_EXTI_LINE  EXTI_Line7
#define UL2_GPIO_PIN_SOURCE  GPIO_PinSource10
...
#define MEASURE_INTERVAL 5000  //单位：us  //由实验测量大于等于500us较为合适，
